...
class Means extends Model
{
    ...
    public function getColor()
    {
        ...
        switch ($this->id) {
            case 1:
                return 'rgb(38,42,247, 0.48)';
            break;
            case 2:
                return 'rgb(247,247,38, 0.48)';
            break;
            case 3:
                return 'rgb(247,38,38, 0.48)';
            break;
            case 4:
                return 'rgb(247,142,38, 0.48)';
            break;
            case 5:
                return 'rgb(38,247,247, 0.48)';
            break;
            default:
                return Arr::random($array_colors);
            break;
        }
    }
}
