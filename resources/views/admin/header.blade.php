          ...
          <li>
            <div class="btn-group">
              <button type="button" class="btn btn-logged" data-toggle="dropdown">
                <img src="https://ui-avatars.com/api/?name={{ str_replace(' ', '+', ucwords(Auth::user()->name)) }}" alt="" />
                {{ Auth::user()->name }}
                ...
                <li>
                  <a href="{{ route('logout') }}"
                    onclick="event.preventDefault();
                      document.getElementById('logout-form').submit();"><i class="glyphicon glyphicon-log-out"></i> Salir</a>
