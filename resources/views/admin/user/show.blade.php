...
<div class="row profile-wrapper">
    <div class="col-xs-12 col-md-3 col-lg-2 profile-left">
        <div class="profile-left-heading">
            ...
            <ul class="list-group">
                <li class="list-group-item">Noticias <a href="timeline.html">1,333</a></li>
                <li class="list-group-item">Enviadas <a href="people-directory.html">541</a></li>
                <li class="list-group-item">Sin enviar <a href="people-directory-grid.html">32,434</a></li>
            </ul>
    ...
    <div class="col-md-3 col-lg-2 profile-sidebar">
        <div class="row">
            <div class="col-sm-6 col-md-12">
                <div class="panel">
                    <div class="panel-heading">
                        <h4 class="panel-title">Temas asignados (lista)</h4>
                    </div>
                    <div class="panel-body">
